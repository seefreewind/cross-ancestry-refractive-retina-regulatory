...
Retinal regulatory annotations were derived from the Human Retina Cell Atlas (Li et al. 2026). Broad retinal OCRs were defined from the union retinal open-chromatin annotation. Ancestry-associated DARs were defined from the atlas ancestry-DAR table using the source definition. The final analysis counts were 380,615 SNPs in all retinal OCRs, 1,232 SNPs in ancestry-associated DARs and 379,279 SNPs in the eligible non-DAR retinal OCR comparator. Of the 1,232 ancestry-associated DAR SNPs, 1,069 overlapped the broad retinal OCR annotation, whereas 163 source-defined DAR SNPs fell outside the union-OCR annotation. Eligible non-DAR retinal OCR comparator SNPs were defined after DAR exclusion and interval-level comparator filtering, which excluded 267 additional OCR non-DAR SNPs.
