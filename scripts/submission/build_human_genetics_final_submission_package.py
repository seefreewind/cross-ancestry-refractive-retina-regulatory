...
Using public EUR no-23andMe and EAS refractive-error summary statistics, ancestry-matched LD score regression, S-LDXR and retinal regulatory annotations, we found predominantly shared EUR–EAS common-variant architecture. Genome-wide S-LDXR GCORSQ was 1.028 (SE = 0.100), and broad retinal OCRs showed a compatible estimate of 0.948 (SE = 0.097). In the primary DAR analysis, 71 of 1,232 ancestry-associated DAR SNPs and 19,653 of 379,279 eligible non-DAR retinal OCR comparator SNPs fell in the top 5% association-effect heterogeneity endpoint (OR = 1.119, 95% CI 0.867–1.423, P = 0.367; matched permutation P = 0.334). The confidence interval excluded a large OR = 1.5 enrichment under the tested endpoint, while leaving modest or local effects unresolved.
